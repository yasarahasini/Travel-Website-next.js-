...
const News = () => {
    ...
    <div className='pt-20 pb-16'>
        ...
        <div className='w-[80%] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-10 items-center mt-20'>
            ...
            data-aos-anchor-placement="top-center" date-aos-delay="300">
              ...
              <div data-aos="fade-left"
            data-aos-anchor-placement="top-center" date-aos-delay="100">
  ...
  <div data-aos="fade-left"
            data-aos-anchor-placement="top-center" date-aos-delay="200">
              ...
              <div data-aos="fade-left"
            data-aos-anchor-placement="top-center" date-aos-delay="400">
